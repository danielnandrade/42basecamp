...
/*   Updated: 2021/05/02 23:02:11 by dnunes-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		check_for_valid_board(int board[4][4][13])
{
			...
			case its a 3 midle 4 and 2
						
		if (ip_row[0][i] == 3 && board[2][i][0] == 4 && board[1][i][0] == 2)
			board[0][i][0] = 1;
		if (ip_row[1][i] == 3 && board[1][i][0] == 4 && board[2][i][0] == 2)
			board[0][i][0] = 1;
